...
namespace QuanLyNhanKhauQuan {
	public static class Db {
		...
		public static void NapComboBox(ComboBox comboBox, string sql, string displayMember, string valueMember) {
			DataTable table = LayDuLieu(sql);
		...
		public static bool KiemTraTrong(TextBox textBox, string tenTruong) {
		...
		public static bool KiemTraChon(ComboBox comboBox, string tenTruong) {
		...
		public static bool KiemTraSoDienThoai(TextBox textBox) {
		...
		public static bool KiemTraCCCD(TextBox textBox) {
		...
		public static void BaoLoi(Exception exception) {
			MessageBox.Show(
