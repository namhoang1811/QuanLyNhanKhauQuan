...
namespace QuanLyNhanKhauQuan
{
    public partial class FormNhanKhau : Form
    {
        ...
        {
            if (!Db.KiemTraTrong(txtMaNhanKhau, "mã nhân khẩu"))
            {
                return false;
            }

            if (!Db.KiemTraTrong(txtHoTenChuHo, "họ tên chủ hộ"))
            {
                return false;
            }
            ...
            if (!Db.KiemTraTrong(txtCCCD, "CCCD"))
            {
                return false;
            }
            ...
            if (!Db.KiemTraTrong(txtDiaChi, "địa chỉ"))
            {
                return false;
            }
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            try
            {
                if (!Db.KiemTraTrong(txtMaNhanKhau, "mã nhân khẩu cần xóa"))
                {
                    return;
                }
